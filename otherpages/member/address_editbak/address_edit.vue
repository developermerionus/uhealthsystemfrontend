	...
	<view class="address-edit-content" :data-theme="themeStyle">
		<view class="edit-wrap">
			...
			<view class="edit-item">
				...
				<input class="uni-input" type="text" placeholder-class="placeholder-class" :placeholder="$lang('consigneePlaceholder')"
			...
			<!-- <view class="edit-item">
				...
				<input class="uni-input" type="text" placeholder-class="placeholder-class" :placeholder="$lang('telephonePlaceholder')"
				 maxlength="20" v-model="formData.telephone" />
			</view> -->
			<!--  外卖地址区分 -->
