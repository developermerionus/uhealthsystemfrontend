		...
		<view class="banner-container">
			...
			<view class="image-container item-center" >
				<view class="slide-image">
					...
					<image :src="$util.img('upload/uniapp/level/card-bg.png')"></image>
					<view class="info" >
						...
						<button type="default" class="renew-btn"  @click="$util.redirectTo('/otherpages/member/card_buy/card_buy')">立即续费</button>
					</view>
				</view>
			</view>
