<template>
	<view class="fenxiao_index" :data-theme="themeStyle">
		<block v-if="info.fenxiao_name">
			<!-- 头部 -->
			<view class="fenxiao_index_header color-base-bg" :data-theme="themeStyle">
				<view class="member">
					...
					<view @click="$util.redirectTo('/otherpages/fenxiao/promote_code/promote_code')" class="manu-list-box">
			...
			<view class="fenxiao-index-allmoney">
				...
				<view class="allmoney-bottom">
					<view class="allmoney-today">
						<view class="today font-size-base color-base-text">{{ info.today_commission|moneyFormat }}</view>
						<view class="font-size-sub">今日收入 (元)</view>
					</view>
					<view class="allmoney-all-wrap" @click="$util.redirectTo('/otherpages/fenxiao/order/order', {type: 1})">
						<view class="allmoney-all font-size-base color-base-text">{{ info.in_progress_money|moneyFormat }}</view>
						<view class="font-size-sub">进行中 (元)</view>
					</view>
					<view class="allmoney-all-wrap">
						<view class="allmoney-all font-size-base color-base-text">{{ info.today_order_money|moneyFormat }}</view>
		...
		<view class="margin-top"><ns-copy-right></ns-copy-right></view>
...
export default {
	...
	methods: {
		...
		toLevel() {
			this.$util.redirectTo('/otherpages/fenxiao/level/level');
		},
		getTeamNum() {
			this.$api.sendRequest({
