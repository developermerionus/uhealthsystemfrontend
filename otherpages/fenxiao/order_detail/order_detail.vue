		...
		<view class="order-detail">
			<view class="order-detail-box">
							...
							<view class="goods-sub-section margin-top">
								<view>
									<text class="goods-price">
										...
										<text class="color-base-text font-size-toolbar">{{ orderData.price }}</text>
									</text>
								</view>
								<view>
									<text>
				...
				<view class="detail-footer">
					...
					<text>
						<text>合计：</text>
						<text class="color-base-text total">${{ orderData.real_goods_money }}</text>
					</text>
				</view>
			</view>
			<view class="order-detail-box commission">
				...
				<view class="detail-content">
					...
					<view class="order-info-item">
						...
						<text class="color-base-text font-size-toolbar">
