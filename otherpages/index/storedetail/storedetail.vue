<template>
	<scroll-view scroll-y :data-theme="themeStyle" class="diy-wrap" :style="{ background: bgColor }">
		...
		<scroll-view scroll-y="true"  :style="{ height: 'calc(100vh - headerHeight - 55px)'  }">
			<view class="bg-index" :style="'background:' + 'url(' + $util.img(bgUrl) + ') no-repeat 0 0/100%'"><diy-group :diyData="diyData" :storeId="storeId"></diy-group></view>
		</scroll-view>
