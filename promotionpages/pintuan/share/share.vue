	...
	<view :data-theme="themeStyle">
		<view class="pintuan-wrap">
			<view class="pintuan-list">
				<image class="pintuan-bg" :src="$util.img('upload/uniapp/pintuan/pintuan_bg.png')" @error="imageError()" mode="widthFix"></image>
				<view class="list-item" @click="toPintuanDetail(groupDetail.pintuan_goods_id)">
					<view class="item-image">
						<image :src="$util.img(groupDetail.sku_image, { size: 'big' })" @error="imageError()" mode="widthFix"></image>
					</view>
				...
				<view class="headimg-group">
					<view class="group-member" v-for="(item, index) in groupDetail.member_list" :key="index" v-if="index < 5">
						...
						<view class="member-face">
							<image :src="item.member_img ? $util.img(item.member_img) : $util.img('/upload/uniapp/default_headimg.png')"
...
<script>
	...
	export default {
		...
		methods: {
			...
			copyUrl() {
				let text = this.$config.h5Domain + '/promotionpages/pintuan/detail/detail?pintuan_id=' + this.groupDetail.pintuan_id +
		...
		onShareAppMessage(res) {
			var path = '/promotionpages/pintuan/detail/detail?id=' + this.groupDetail.pintuan_goods_id + '&group_id=' + this.groupDetail
				.group_id;
