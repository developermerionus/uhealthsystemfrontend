			...
			<view class="goods-container">
				...
				<ns-goods-action :safeArea="isIphoneX">
					<template v-if="goodsSkuDetail.goods_state == 1">
						...
						<block v-else>
							<ns-goods-action-button class="goods-action-button active4" :text-price="'最低$ ' + goodsSkuDetail.show_price"
							 text="去砍价" @click="bargain" v-if="goodsSkuDetail.bargain_stock > 0 || (goodsSkuDetail.bargain_stock == 0 && goodsSkuDetail.sku_spec_format)" />
