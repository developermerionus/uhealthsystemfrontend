			...
			<block slot="list">
				...
				<view class="body-wrap" :class="{ 'no-login': !token }">
						...
						<view class="list-wrap">
							<view class="list-wrap-scroll">
								<view class="list-wrap-item coupon-list-wrap-item" v-for="(couponItem, couponIndex) in couponList" :key="couponIndex" @click="toDetail(couponItem)">
									<view class="img-box"><image :src="$util.img('upload/uniapp/point/coupon_'+themeStyle+'_bg1.png')" @error="imageError(couponIndex)"></image></view>
									<view class="content">
										<!-- <view class="coupon-price-wrap">
											...
											<view class="coupon-point">
												<view class="coupon-point-num">
													<image :src="$util.img('upload/uniapp/point/rechange.png')"></image>
										...
										<view class="coupon" :style="{ backgroundImage: 'url(' + $util.img('upload/uniapp/point/coupon_'+themeStyle+'_bg1.png') + ')' }">
					...
					<view class="point-exchange-wrap" v-if="hongbaoList.length > 0">
						...
						<view class="list-wrap">
							<view class="list-wrap-item hongbao-list-wrap-item" v-for="(hongbaoItem, hongbaoIndex) in hongbaoList" :key="hongbaoIndex"
							 @click="toDetail(hongbaoItem)">
								<view class="img-box">
									<image :src="$util.img('upload/uniapp/point/hongbao_bg.png')"></image>
								</view>
								<view class="content">
