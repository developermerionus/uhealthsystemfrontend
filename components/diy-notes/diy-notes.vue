					...
					<view class="notes-item">
						...
						<view class="notes-item-con">
							<view class="notes-info" v-if="(value.readNum == 1 && item.is_show_read_num == 1) || (value.uploadTime == 1 && item.is_show_release_time == 1)">
								...
								<!-- <view class="notes-num">
									<text v-show="value.thumbsUpNum == 1 && item.is_show_dianzan_num == 1" @click.stop="giveLike(item.note_id, i)">
										<text class="iconfont iconlikefill color-base-text" v-if="item.is_dianzan == 1"></text>
										<text class="iconfont icongz" v-else></text>
										<text>{{item.initial_dianzan_num + item.dianzan_num}}</text>
									</text>
								</view> -->
							</view>
						</view>
