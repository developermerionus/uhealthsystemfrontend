		...
		<view @touchmove.prevent.stop v-if="reward" class="reward-popup">
			<uni-popup ref="registerReward" type="center" :maskClick="false">
				<view class="reward-wrap">
					<image :src="$util.img('upload/uniapp/register_reward_img.png')" mode="widthFix" class="bg-img-head"></image>
					<image :src="$util.img('upload/uniapp/register_reward_money.png')" mode="widthFix" class="bg-img-money"></image>
					<image :src="$util.img('upload/uniapp/register_reward_head.png')" mode="widthFix" class="bg-img"></image>
					<view class="wrap">
						<view>
