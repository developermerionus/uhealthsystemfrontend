			...
			<view class="nav_top_category">
				<scroll-view class="diyIndex widthAuto" @click="changePageIndex(0)">
					<view
						...
						:style="{ background: pageIndex == 0 && value.styleType == 'fill' ? (value.selectColor ? value.selectColor : '') : '' }"
					>
						<view
							class="text-con"
				...
				>
					<view
						...
						:class="{ fill: value.styleType == 'fill' }"
						:style="{ background: index == pageIndex && value.styleType == 'fill' ? (value.selectColor ? value.selectColor : '') : '' }"
						v-if="index > 0"
					>
						<view
							class="text-con"
						...
						<view class="twoCategorylist" v-if="twoCategorylist != 'undefined' && twoCategorylist && twoCategorylist.length > 0">
							...
							<view class="dot-box">
								<view
									...
									v-if="maxPage > 1"
									:key="page"
									:class="twoCategorylistId == page ? 'active color-base-bg' : ''"
								></view>
							</view>
						</view>
