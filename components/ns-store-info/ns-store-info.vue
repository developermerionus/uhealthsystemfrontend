		...
		<view class="store-info-top">
			...
			<view class="info-desc">
				...
				<view class="store-sign">
					<text class="ns-gradient-promotionpages-pintuan-payment color-base-text" :data-theme="themeStyle">营业中</text>
					<text class="ns-gradient-promotionpages-pintuan-payment color-base-text" :data-theme="themeStyle">门店自提</text>
				</view>
			</view>
...
export default {
	...
	methods: {
		...
		mapRoute() {
			Map.openMap(Number(this.latitude), Number(this.longitude), this.store_name, 'wgs84');
		},
		clearStore() {
