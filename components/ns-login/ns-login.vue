	...
	<view>
		<view @touchmove.prevent.stop>
			<uni-popup ref="auth" :custom="true" :mask-click="false">
				<view class="uni-tip">
					<view class="uni-tip-title">{{$lang('common.yet_to_logon')}}</view>
					<view class="uni-tip-content">{{$lang('common.logon_note')}}</view>
					<view class="uni-tip-icon"><image :src="$util.img('/upload/uniapp/member/login.png')" mode="widthFix"></image></view>
					<view class="uni-tip-group-button">
						<button type="default" class="uni-tip-button color-title close" @click="close">{{$lang('common.cancel')}}</button>
						<!-- #ifdef MP-WEIXIN || MP-QQ || MP-BAIDU  -->
						<button type="primary" open-type="getUserInfo" @getuserinfo="login" class="uni-tip-button">{{$lang('common.logon_now')}}</button>
						<!-- #endif  -->
						<!-- #ifdef MP-ALIPAY -->
						...
						<!-- #endif  -->
						<!-- #ifdef APP-PLUS || H5 -->
						<button type="primary" class="uni-tip-button color-base-bg" @click="login">{{$lang('common.logon_now')}}</button>
						<!-- #endif  -->
					</view>
				</view>
			</uni-popup>
